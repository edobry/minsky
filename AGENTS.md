...
Stop-event sibling (mt#2357): `turn-end-retro-scan.ts` — advisory turn-end scan (Stop
dispatcher); dedup caps each phrase at one beat; same override/log (`channel:"stop"`).
