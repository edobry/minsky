...
`guard-health-escalation-detector` (mt#2812, a new guard registered directly, not part of the
Phase 2 legacy-settings.json migration — 16 guards total in this family as of mt#2812).
