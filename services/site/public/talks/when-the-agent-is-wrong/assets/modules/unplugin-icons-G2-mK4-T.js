import { G as l, Y as a, i as o, f as e } from "./vue-D4u9h7Td.js";
const r = { class: "slidev-icon", viewBox: "0 0 256 256", width: "1.2em", height: "1.2em" };
function s(t, n) {
  return (
    a(),
    o("svg", r, [
...
const f = l({ name: "ph-clipboard", render: s }),
  i = { class: "slidev-icon", viewBox: "0 0 256 256", width: "1.2em", height: "1.2em" };
function c(t, n) {
  return (
    a(),
    o("svg", i, [
...
const w = l({ name: "ph-check-circle", render: c }),
  h = { class: "slidev-icon", viewBox: "0 0 32 32", width: "1.2em", height: "1.2em" };
function d(t, n) {
  return (
    a(),
    o("svg", h, [
...
const x = l({ name: "carbon-sun", render: d }),
  u = { class: "slidev-icon", viewBox: "0 0 32 32", width: "1.2em", height: "1.2em" };
function m(t, n) {
  return (
    a(),
    o("svg", u, [
...
const M = l({ name: "carbon-moon", render: m }),
  _ = { class: "slidev-icon", viewBox: "0 0 256 256", width: "1.2em", height: "1.2em" };
function p(t, n) {
  return (
    a(),
    o("svg", _, [
      ...(n[0] ||
        (n[0] = [
          e(
            ...
            [
              e("path", {
                d: "M213.66 201L201 213.66a8 8 0 0 1-11.31 0l-51.31-51.31a8 8 0 0 0-13 2.46l-17.82 46.41a8 8 0 0 1-14.85-.71L40.41 50.44a8 8 0 0 1 10-10l160.1 52.24a8 8 0 0 1 .71 14.85l-46.41 17.82a8 8 0 0 0-2.46 13l51.31 51.31a8 8 0 0 1 0 11.34",
                opacity: ".2",
              }),
              e("path", {
...
const $ = l({ name: "ph-cursor-duotone", render: p }),
  v = { class: "slidev-icon", viewBox: "0 0 256 256", width: "1.2em", height: "1.2em" };
function g(t, n) {
  return (
    a(),
    o("svg", v, [
      ...(n[0] ||
        (n[0] = [
          e(
            ...
            {
              fill: "currentColor",
              d: "m220.49 207.8l-12.69 12.69a12 12 0 0 1-17 0l-56.57-56.57L115 214.08l-.13.33a15.84 15.84 0 0 1-14.61 9.59h-.78a15.82 15.82 0 0 1-14.41-11L32.8 52.92A15.95 15.95 0 0 1 52.92 32.8L213 85.07a16 16 0 0 1 1.41 29.8l-.33.13l-50.16 19.27l56.57 56.56a12 12 0 0 1 0 16.97",
            },
            null,
            -1
          ),
...
const B = l({ name: "ph-cursor-fill", render: g });
export { M as _, B as a, w as b, x as c, f as d, $ as e };
