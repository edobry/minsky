import {
  ...
  M as to,
  s as oo,
} from "./vue-D4u9h7Td.js";
const io = ["top", "right", "bottom", "left"],
  Xe = ["start", "end"],
  Ue = io.reduce((e, t) => e.concat(t, `${t}-${Xe[0]}`, `${t}-${Xe[1]}`), []),
  de = Math.min,
  J = Math.max,
...
function yt(e, t, o) {
  ...
  const i = M(e),
    ...
    s = We(n);
  let r =
    n === "x" ? (i === (o ? "end" : "start") ? "right" : "left") : i === "start" ? "bottom" : "top";
...
function ie(e) {
  ...
  return { width: i, height: n, top: o, left: t, right: t + i, bottom: o + n, x: t, y: o };
}
function Je(e, t, o) {
  const { reference: i, floating: n } = e;
  const s = V(t),
    r = je(t),
    a = We(r),
    l = F(t),
  ...
  switch (l) {
    case "top":
      h = { x: p, y: i.y - n.height };
      break;
    case "bottom":
      h = { x: p, y: i.y + i.height };
      break;
    case "right":
      h = { x: i.x + i.width, y: c };
      break;
...
async function ho(e, t) {
  ...
  const { x: i, y: n, platform: s, rects: r, elements: a, strategy: l } = e,
    ...
    f = $t(h),
    w = a[u ? (c === "floating" ? "reference" : "floating") : c],
    g = ie(
      await s.getClippingRect({
        element:
          (o = await (s.isElement == null ? void 0 : s.isElement(w))) == null || o
            ? w
            : w.contextElement ||
  ...
  return {
    top: (g.top - T.top + f.top) / _.y,
    bottom: (T.bottom - g.bottom + f.bottom) / _.y,
    left: (g.left - T.left + f.left) / _.x,
    right: (T.right - g.right + f.right) / _.x,
  };
}
const uo = 50,
  fo = async (e, t, o) => {
    const {
      ...
      a = r.detectOverflow ? r : { ...r, detectOverflow: ho },
      l = await (r.isRTL == null ? void 0 : r.isRTL(t));
    let d = await r.getElementRects({ reference: e, floating: t, strategy: n }),
      { x: p, y: c } = Je(d, i, l),
      u = i,
      h = 0;
    const f = {};
        ...
        b &&
          ...
          typeof b == "object" &&
            ...
            b.rects &&
              (d =
                b.rects === !0
                  ? await r.getElementRects({ reference: e, floating: t, strategy: n })
                  : b.rects),
            ({ x: p, y: c } = Je(d, u, l))),
          (m = -1));
    }
    return { x: p, y: c, placement: u, strategy: n, middlewareData: f };
  },
  mo = (e) => ({
    name: "arrow",
    options: e,
    async fn(t) {
      const { x: o, y: i, placement: n, rects: s, platform: r, elements: a, middlewareData: l } = t,
        { element: d, padding: p = 0 } = ee(e, t) || {};
      if (d == null) return {};
      const c = $t(p),
        u = { x: o, y: i },
        h = je(n),
        f = We(h),
        m = await r.getDimensions(d),
        w = h === "y",
        g = w ? "top" : "left",
        v = w ? "bottom" : "right",
        $ = w ? "clientHeight" : "clientWidth",
        _ = s.reference[f] + s.reference[h] - u[h] - s.floating[f],
        T = u[h] - s.reference[h],
        b = await (r.getOffsetParent == null ? void 0 : r.getOffsetParent(d));
      let S = b ? b[$] : 0;
      (!S || !(await (r.isElement == null ? void 0 : r.isElement(b)))) &&
        (S = a.floating[$] || s.floating[f]);
      const R = _ / 2 - T / 2,
        C = S / 2 - m[f] / 2 - 1,
        x = de(c[g], C),
        A = de(c[v], C),
        ...
        I =
          ...
          M(n) != null &&
          P !== K &&
          s.reference[f] / 2 - (P < O ? x : A) - m[f] / 2 < 0,
        L = I ? (P < O ? P - O : P - E) : 0;
      return {
        [h]: u[h] + L,
        data: { [h]: K, centerOffset: P - K - L, ...(I && { alignmentOffset: L }) },
        reset: I,
      };
    },
  });
function go(e, t, o) {
  return (
    e
      ? [...o.filter((n) => M(n) === e), ...o.filter((n) => M(n) !== e)]
      : o.filter((n) => F(n) === n)
  ).filter((n) => (e ? M(n) === e || (t ? ye(n) !== n : !1) : !0));
}
const wo = function (e) {
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          let o, i, n;
          const { rects: s, middlewareData: r, placement: a, platform: l, elements: d } = t,
            {
              crossAxis: p = !1,
              alignment: c,
            ...
            m = c !== void 0 || u === Ue ? go(c || null, h, u) : u,
            w = await l.detectOverflow(t, f),
            g = ((o = r.autoPlacement) == null ? void 0 : o.index) || 0,
            v = m[g];
          if (v == null) return {};
          const $ = yt(v, s, await (l.isRTL == null ? void 0 : l.isRTL(d.floating)));
          if (a !== v) return { reset: { placement: m[0] } };
          const _ = [w[F(v)], w[$[0]], w[$[1]]],
            T = [
              ...(((i = r.autoPlacement) == null ? void 0 : i.overflows) || []),
              { placement: v, overflows: _ },
            ],
            b = m[g + 1];
          if (b) return { data: { index: g + 1, overflows: T }, reset: { placement: b } };
          const S = T.map((x) => {
              const A = M(x.placement);
              return [
                x.placement,
                A && p ? x.overflows.slice(0, 2).reduce((O, E) => O + E, 0) : x.overflows[0],
                x.overflows,
              ];
            }).sort((x, A) => x[1] - A[1]),
            C =
              ((n = S.filter((x) => x[2].slice(0, M(x[0]) ? 2 : 3).every((A) => A <= 0))[0]) == null
                ? void 0
                : n[0]) || S[0][0];
          return C !== a ? { data: { index: g + 1, overflows: T }, reset: { placement: C } } : {};
        },
      }
    );
  },
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          const g = F(n),
            v = V(a),
            $ = F(a) === a,
            _ = await (l.isRTL == null ? void 0 : l.isRTL(d.floating)),
            T = u || ($ || !m ? [$e(a)] : so(a)),
            b = f !== "none";
          !u && b && T.push(...po(a, m, f, _));
          const S = [a, ...T],
          ...
          if (((x = [...x, { placement: n, overflows: C }]), !C.every((P) => P <= 0))) {
            let A, O;
            const P = (((A = s.flip) == null ? void 0 : A.index) || 0) + 1,
              K = S[P];
            if (
              K &&
              (!(c === "alignment" ? v !== V(K) : !1) ||
                x.every((N) => (V(N.placement) === v ? N.overflows[0] > 0 : !0)))
            )
              return { data: { index: P, overflows: x }, reset: { placement: K } };
            let I =
              (O = x
                .filter((L) => L.overflows[0] <= 0)
                .sort((L, N) => L.overflows[1] - N.overflows[1])[0]) == null
                ? void 0
                : O.placement;
            if (!I)
              switch (h) {
                case "bestFit": {
                  ...
                  const L =
                    (E = x
                      ...
                      .map((N) => [
                        N.placement,
                        N.overflows.filter((j) => j > 0).reduce((j, qt) => j + qt, 0),
                      ])
      ...
      e === void 0 && (e = 0),
      {
        ...
        async fn(t) {
          ...
          return r === ((o = a.offset) == null ? void 0 : o.placement) &&
            ...
            i.alignmentOffset
            ? {}
            : { x: n + l.x, y: s + l.y, data: { ...l, placement: r } };
        },
      }
    );
  },
  xo = function (e) {
    return (
      e === void 0 && (e = {}),
      {
        ...
        options: e,
        async fn(t) {
          const { x: o, y: i, placement: n, platform: s } = t,
            {
              mainAxis: r = !0,
              crossAxis: a = !1,
              limiter: l = {
          ...
          const w = l.fn({ ...t, [h]: f, [u]: m });
          return { ...w, data: { x: w.x - o, y: w.y - i, enabled: { [h]: r, [u]: a } } };
        },
      }
    );
  },
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          const { placement: n, rects: s, platform: r, elements: a } = t,
            { apply: l = () => {}, ...d } = ee(e, t),
            p = await r.detectOverflow(t, d),
            c = F(n),
            u = M(n),
            h = V(n) === "y",
            { width: f, height: m } = s.floating;
          let w, g;
          c === "top" || c === "bottom"
            ? ((w = c),
              (g =
                u === ((await (r.isRTL == null ? void 0 : r.isRTL(a.floating))) ? "start" : "end")
                  ? "left"
                  : "right"))
            : ((g = c), (w = u === "end" ? "top" : "bottom"));
          const v = m - p.top - p.bottom,
            $ = f - p.left - p.right,
            _ = de(m - p[w], v),
            T = de(f - p[g], $),
          ...
          let S = _,
            R = T;
          if (
            ((o = t.middlewareData.shift) != null && o.enabled.x && (R = $),
            (i = t.middlewareData.shift) != null && i.enabled.y && (S = v),
            b && !u)
          ) {
            const x = J(p.left, 0),
              A = J(p.right, 0),
              ...
              E = J(p.bottom, 0);
            h
              ? (R = f - 2 * (x !== 0 || A !== 0 ? x + A : J(p.left, p.right)))
              : (S = m - 2 * (O !== 0 || E !== 0 ? O + E : J(p.top, p.bottom)));
          }
          await l({ ...t, availableWidth: R, availableHeight: S });
          const C = await r.getDimensions(a.floating);
          return f !== C.width || m !== C.height ? { reset: { rects: !0 } } : {};
        },
      }
    );
  };
...
function te(e) {
  ...
  const o = t.getBoundingClientRect(),
    { width: i, height: n, fallback: s } = _t(t);
...
function pe(e, t, o, i) {
  ...
  const r = e.getBoundingClientRect(),
    a = Pt(e);
  let l = St;
  t && (i ? Y(i) && (l = te(i)) : (l = te(e)));
  const d = a ? z(a) : window,
    p = !Tt() && o;
  let c = (r.left + ((p && ((n = d.visualViewport) == null ? void 0 : n.offsetLeft)) || 0)) / l.x,
    u = (r.top + ((p && ((s = d.visualViewport) == null ? void 0 : s.offsetTop)) || 0)) / l.y,
    h = r.width / l.x,
    f = r.height / l.y;
  if (a) {
    const m = z(a),
    ...
    for (; g && i && w !== m; ) {
      ...
      ($.x += (g.clientLeft + parseFloat(_.paddingLeft)) * v.x),
        ($.y += (g.clientTop + parseFloat(_.paddingTop)) * v.y),
        (c *= v.x),
        (u *= v.y),
        (h *= v.x),
        (f *= v.y),
  ...
  return { width: h, height: f, top: u, right: c + h, bottom: u + f, left: c, x: c, y: u };
}
function X(e) {
...
function At(e) {
  return pe(X(e)).left + Ae(e).scrollLeft;
}
function ce(e) {
...
function Ct(e) {
  const t = ce(e);
  return qe(t) ? t.ownerDocument.body : D(t) && Se(t) ? t : Ct(t);
}
function xe(e, t) {
  let o;
  t === void 0 && (t = []);
  const i = Ct(e),
    ...
    s = z(i);
  return n ? t.concat(s, s.visualViewport || [], Se(i) ? i : []) : t.concat(i, xe(i));
}
function tt(e, t, o) {
  return t === "viewport"
    ? ie(
        (function (i, n) {
          ...
          if (a) {
            ...
            const u = Tt();
            (u || (!u && n === "fixed")) && ((p = a.offsetLeft), (c = a.offsetTop));
          }
          return { width: l, height: d, x: p, y: c };
        })(e, o)
      )
    : Y(t)
      ? ie(
          (function (i, n) {
            const s = pe(i, !0, n === "fixed"),
              r = s.top + i.clientTop,
      ...
      : ie(
          (function (i) {
            const n = X(i),
              ...
              a = ne(n.scrollWidth, n.clientWidth, r.scrollWidth, r.clientWidth),
              l = ne(n.scrollHeight, n.clientHeight, r.scrollHeight, r.clientHeight);
            let d = -s.scrollLeft + At(i);
            const p = -s.scrollTop;
            return (
              B(r).direction === "rtl" && (d += ne(n.clientWidth, r.clientWidth) - a),
              { width: a, height: l, x: d, y: p }
            );
          })(X(e))
        );
}
...
function it(e) {
  const t = z(e);
  let o = ot(e);
  for (; o && To(o) && B(o).position === "static"; ) o = ot(o);
  return o && (U(o) === "html" || (U(o) === "body" && B(o).position === "static" && !Ee(o)))
    ? t
    : o ||
        (function (i) {
          let n = ce(i);
...
const So = {
    getClippingRect: function (e) {
      const { element: t, boundary: o, rootBoundary: i, strategy: n } = e;
      const s =
          o === "clippingAncestors"
            ? (function (d, p) {
                const c = p.get(d);
                if (c) return c;
                let u = xe(d).filter((w) => Y(w) && U(w) !== "body"),
                  h = null;
        ...
        l = r.reduce(
          (d, p) => {
            const c = tt(t, p, n);
            return (
              (d.top = ne(c.top, d.top)),
              (d.right = Qe(c.right, d.right)),
              (d.bottom = Qe(c.bottom, d.bottom)),
              (d.left = ne(c.left, d.left)),
              d
            );
          },
          tt(t, a, n)
    ...
    convertOffsetParentRelativeRectToViewportRelativeRect: function (e) {
      const { rect: t, offsetParent: o, strategy: i } = e;
      const n = D(o),
        s = X(o);
      if (o === s) return t;
      let r = { scrollLeft: 0, scrollTop: 0 },
        a = { x: 1, y: 1 };
      const l = { x: 0, y: 0 };
      if ((n || (!n && i !== "fixed")) && ((U(o) !== "body" || Se(s)) && (r = Ae(o)), D(o))) {
        const d = pe(o);
    ...
    async getElementRects(e) {
      const { reference: t, floating: o, strategy: i } = e;
      const n = this.getOffsetParent || it,
        s = this.getDimensions;
      return { reference: Po(t, await n(o), i), floating: { x: 0, y: 0, ...(await s(o)) } };
    },
    getClientRects: (e) => Array.from(e.getClientRects()),
    isRTL: (e) => B(e).direction === "rtl",
  },
  Ao = (e, t, o) => {
    const i = new Map(),
      n = { platform: So, ...o },
      s = { ...n.platform, _c: i };
    return fo(e, t, { ...n, platform: s });
  };
function Ot(e, t) {
  for (const o in t)
    Object.prototype.hasOwnProperty.call(t, o) &&
      (typeof t[o] == "object" && e[o] ? Ot(e[o], t[o]) : (e[o] = t[o]));
}
const H = {
  disabled: !1,
  distance: 5,
...
function Co(e) {
  const t = [e];
  let o = H.themes[e] || {};
  do o.$extend && !o.$resetCss ? (t.push(o.$extend), (o = H.themes[o.$extend] || {})) : (o = null);
  while (o);
...
function nt(e) {
  const t = [e];
  let o = H.themes[e] || {};
  do o.$extend ? (t.push(o.$extend), (o = H.themes[o.$extend] || {})) : (o = null);
  while (o);
  return t;
}
let oe = !1;
...
typeof window < "u" &&
  typeof navigator < "u" &&
  (zt = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream);
const Lt = ["auto", "top", "bottom", "left", "right"].reduce(
...
const Ne = "__floating-vue__popper",
  Nt = () =>
    Pe({
      name: "VPopper",
      provide() {
        return { [Ne]: { parentPopper: this } };
      },
      inject: { [Ne]: { default: null } },
      props: {
        ...
        ariaId: { default: null },
        disabled: { type: Boolean, default: y("disabled") },
        positioningDisabled: { type: Boolean, default: y("positioningDisabled") },
        placement: { type: String, default: y("placement"), validator: (e) => Lt.includes(e) },
        delay: { type: [String, Number, Object], default: y("delay") },
        distance: { type: [Number, String], default: y("distance") },
        skidding: { type: [Number, String], default: y("skidding") },
        triggers: { type: Array, default: y("triggers") },
        showTriggers: { type: [Array, Function], default: y("showTriggers") },
        hideTriggers: { type: [Array, Function], default: y("hideTriggers") },
        popperTriggers: { type: Array, default: y("popperTriggers") },
        popperShowTriggers: { type: [Array, Function], default: y("popperShowTriggers") },
        popperHideTriggers: { type: [Array, Function], default: y("popperHideTriggers") },
        container: { type: [String, Object, Be, Boolean], default: y("container") },
        boundary: { type: [String, Be], default: y("boundary") },
        strategy: {
          type: String,
          validator: (e) => ["absolute", "fixed"].includes(e),
          default: y("strategy"),
        },
        autoHide: { type: [Boolean, Function], default: y("autoHide") },
        handleResize: { type: Boolean, default: y("handleResize") },
        instantMove: { type: Boolean, default: y("instantMove") },
        eagerMount: { type: Boolean, default: y("eagerMount") },
        popperClass: { type: [String, Array, Object], default: y("popperClass") },
        computeTransformOrigin: { type: Boolean, default: y("computeTransformOrigin") },
        autoMinSize: { type: Boolean, default: y("autoMinSize") },
        autoSize: { type: [Boolean, String], default: y("autoSize") },
        autoMaxSize: { type: Boolean, default: y("autoMaxSize") },
        autoBoundaryMaxSize: { type: Boolean, default: y("autoBoundaryMaxSize") },
        preventOverflow: { type: Boolean, default: y("preventOverflow") },
        overflowPadding: { type: [Number, String], default: y("overflowPadding") },
        arrowPadding: { type: [Number, String], default: y("arrowPadding") },
        arrowOverflow: { type: Boolean, default: y("arrowOverflow") },
        flip: { type: Boolean, default: y("flip") },
        shift: { type: Boolean, default: y("shift") },
        shiftCrossAxis: { type: Boolean, default: y("shiftCrossAxis") },
        noAutoFocus: { type: Boolean, default: y("noAutoFocus") },
        disposeTimeout: { type: Number, default: y("disposeTimeout") },
      },
      emits: {
        show: () => !0,
        hide: () => !0,
      ...
      methods: {
        ...
        async $_computePosition() {
          ...
          (this.distance || this.skidding) &&
            e.middleware.push(_o({ mainAxis: this.distance, crossAxis: this.skidding }));
          const t = this.placement.startsWith("auto");
          if (
            (t
              ? e.middleware.push(wo({ alignment: this.placement.split("-")[1] ?? "" }))
            ...
            this.preventOverflow &&
              ...
              !t &&
                this.flip &&
                e.middleware.push(vo({ padding: this.overflowPadding, boundary: this.boundary }))),
            e.middleware.push(mo({ element: this.$_arrowNode, padding: this.arrowPadding })),
            this.arrowOverflow &&
              e.middleware.push({
                name: "arrowOverflow",
                fn: ({ placement: i, rects: n, middlewareData: s }) => {
                  ...
                  return (
                    i.startsWith("top") || i.startsWith("bottom")
                      ? (r = Math.abs(a) > n.reference.width / 2)
                      : (r = Math.abs(a) > n.reference.height / 2),
                    { data: { overflow: r } }
                  );
                },
              }),
          ...
          Object.assign(this.result, {
            ...
            strategy: o.strategy,
            arrow: { ...o.middlewareData.arrow, ...o.middlewareData.arrowOverflow },
          });
        },
        $_scheduleShow(e, t = !1) {
          if (
            ...
            Z && this.instantMove && Z.instantMove && Z !== this.parentPopper)
          ) {
            ...
            !this.isShown &&
              ...
              this.positioningDisabled ||
                this.$_registerEventListeners(
                  [...xe(this.$_referenceNode), ...xe(this.$_popperNode)],
                  "scroll",
                  () => {
        ...
        async $_applyHide(e = !1) {
          ...
          for (const o of nt(this.theme)) {
            const i = dt(o);
            at(i, this),
              i.length === 0 && document.body.classList.remove(`v-popper--some-open--${o}`);
          }
          Z === this && (Z = null),
            (this.isShown = !1),
        ...
        $_isAimingPopper() {
          ...
          if (se >= e.left && se <= e.right && re >= e.top && re <= e.bottom) {
            const t = this.$_popperNode.getBoundingClientRect(),
              o = se - q,
              i = re - G,
              n = t.left + t.width / 2 - q + (t.top + t.height / 2) - G + t.width + t.height,
              s = q + o * n,
              r = G + i * n;
            return (
              me(q, G, s, r, t.left, t.top, t.left, t.bottom) ||
              me(q, G, s, r, t.left, t.top, t.right, t.top) ||
              me(q, G, s, r, t.right, t.top, t.right, t.bottom) ||
              me(q, G, s, r, t.left, t.bottom, t.right, t.bottom)
            );
          }
          return !1;
        },
...
if (typeof document < "u" && typeof window < "u") {
  if (zt) {
    ...
    document.addEventListener("touchstart", (t) => pt(t, !0), e),
      document.addEventListener("touchend", (t) => ct(t, !0), e);
  } else
    window.addEventListener("mousedown", (e) => pt(e, !1), !0),
      window.addEventListener("click", (e) => ct(e, !1), !0);
  window.addEventListener("resize", De);
}
function pt(e, t) {
  if (H.autoHideOnMousedown) kt(e, t);
  else
    for (let o = 0; o < k.length; o++) {
      const i = k[o];
      try {
...
function kt(e, t) {
  ...
  for (let i = k.length - 1; i >= 0; i--) {
    ...
    try {
      ...
      (n.pendingHide = !1),
        requestAnimationFrame(() => {
          if (((n.pendingHide = !1), !o[n.randomId] && ht(n, s, e))) {
            ...
            for (; r && ht(r, r.containsGlobalTarget, e); )
...
function ht(e, t, o) {
  return o.closeAllPopover || (o.closePopover && t) || (Oo(e, o) && !t);
}
function Oo(e, t) {
...
function De() {
  for (let e = 0; e < k.length; e++) k[e].$_computePosition();
}
let q = 0,
  G = 0,
  se = 0,
...
typeof window < "u" &&
  window.addEventListener(
    "mousemove",
    (e) => {
      (q = se), (G = re), (se = e.clientX), (re = e.clientY);
    },
    oe ? { passive: !0 } : void 0
  );
function me(e, t, o, i, n, s, r, a) {
  const l = ((r - n) * (t - s) - (a - s) * (e - n)) / ((a - s) * (o - e) - (r - n) * (i - t)),
    d = ((o - e) * (t - s) - (i - t) * (e - n)) / ((a - s) * (o - e) - (r - n) * (i - t));
...
function Lo(e, t, o, i, n, s) {
  return (
    ...
    le(
      "div",
      { ref: "reference", class: Ve(["v-popper", { "v-popper--shown": e.slotData.isShown }]) },
      [ve(e.$slots, "default", to(oo(e.slotData)))],
      2
    )
  );
}
const No = Ce(zo, [["render", Lo]]);
function ko() {
  const e = window.navigator.userAgent,
    t = e.indexOf("MSIE ");
  if (t > 0) return parseInt(e.substring(t + 5, e.indexOf(".", t)), 10);
  const o = e.indexOf("Trident/");
  if (o > 0) {
...
const Mo = eo();
Jt("data-v-b329ee4c");
const Ho = { class: "resize-observer", tabindex: "-1" };
Qt();
const Ro = Mo((e, t, o, i, n, s) => (W(), Te("div", Ho)));
Oe.render = Ro;
...
const Mt = (e = "theme") => ({
  ...
  Do = { ref: "inner", class: "v-popper__inner" },
  Fo = Q("div", { class: "v-popper__arrow-outer" }, null, -1),
  Io = Q("div", { class: "v-popper__arrow-inner" }, null, -1),
  Vo = [Fo, Io];
  ...
  return (
    ...
    le(
      "div",
      {
        ...
        onKeyup: t[2] || (t[2] = Kt((a) => e.autoHide && e.$emit("hide"), ["esc"])),
      },
      [
        Q("div", {
        ...
        Q(
          "div",
          {
            ...
            style: ze(e.result ? { transformOrigin: e.result.transformOrigin } : void 0),
          },
          [
            Q(
              "div",
...
const jo = Pe({
  name: "VPopperWrapper",
  components: { Popper: No, PopperContent: Ht },
  mixins: [Rt, Mt("finalTheme")],
  props: {
    ...
    container: { type: [String, Object, Ie, Boolean], default: void 0 },
    boundary: { type: [String, Ie], default: void 0 },
...
function qo(e, t, o, i, n, s) {
  const r = ae("PopperContent"),
    a = ae("Popper");
  return (
    W(),
    Te(
      a,
      wt({ ref: "popper" }, e.$props, {
        theme: e.finalTheme,
      ...
      }),
      {
        default: we(
          ({
            ...
            ve(e.$slots, "default", { shown: d, show: h, hide: f }),
            gt(
              r,
              {
                ref: "popperContent",
              ...
              { default: we(() => [ve(e.$slots, "popper", { shown: d, hide: f })]), _: 2 },
              1032,
              [
                "popper-id",
                "theme",
...
const Ge = Ce(jo, [["render", qo]]),
  Go = { ...Ge, name: "VDropdown", vPopperTheme: "dropdown" },
  Et = { ...Ge, name: "VMenu", vPopperTheme: "menu" },
  Bt = { ...Ge, name: "VTooltip", vPopperTheme: "tooltip" },
  Yo = Pe({
    name: "VTooltipDirective",
    components: { Popper: Nt(), PopperContent: Ht },
    mixins: [Rt],
    inheritAttrs: !1,
    props: {
      theme: { type: String, default: "tooltip" },
      html: { type: Boolean, default: (e) => he(e.theme, "html") },
      content: { type: [String, Number, Function], default: null },
      loadingContent: { type: String, default: (e) => he(e.theme, "loadingContent") },
      targetNodes: { type: Function, required: !0 },
    },
    data() {
        ...
        default: we(
          ({
            ...
            gt(
              ...
              {
                ref: "popperContent",
                class: Ve({ "v-popper--tooltip-loading": e.loading }),
                "popper-id": l,
                theme: e.theme,
                shown: d,
                mounted: p,
              ...
              },
              {
                default: we(() => [
                  e.html
                    ? (W(), le("div", { key: 0, innerHTML: e.finalContent }, null, 8, Xo))
                    : (W(), le("div", { key: 1, textContent: Xt(e.finalContent) }, null, 8, Uo)),
                ]),
                _: 2,
              },
              1032,
...
const Zo = Ce(Yo, [["render", Ko]]),
  Dt = "v-popper--has-tooltip";
function Jo(e, t) {
  let o = e.placement;
  if (!o && t) for (const i of Lt) t[i] && (o = i);
...
function Ft(e, t, o) {
  ...
  const n = typeof t;
  return (
    n === "string" ? (i = { content: t }) : t && n === "object" ? (i = t) : (i = { content: !1 }),
    (i.placement = Jo(i, o)),
    (i.targetNodes = () => [e]),
    (i.referenceNode = () => e),
    i
...
function ei() {
  ...
  (ue = He([])),
    (ke = Gt({
      ...
      setup() {
        return { directives: ue };
      },
      render() {
        return this.directives.map((t) =>
          Yt(Zo, { ...t.options, shown: t.shown || t.options.shown, key: t.id })
        );
      },
      devtools: { hide: !0 },
    }));
...
function ti(e, t, o) {
  ...
  const i = He(Ft(e, t, o)),
    n = He(!1),
    s = { id: Qo++, options: i, shown: n };
  return (
    ue.value.push(s),
    e.classList && e.classList.add(Dt),
    (e.$_popper = {
      options: i,
      item: s,
      show() {
...
function ut(e, { value: t, modifiers: o }) {
  const i = Ft(e, t, o);
  if (!i.content || he(i.theme || "tooltip", "disabled")) It(e);
  else {
    let n;
    e.$_popper ? ((n = e.$_popper), (n.options.value = i)) : (n = ti(e, t, o)),
      typeof t.shown < "u" &&
...
function ft(e) {
  e.addEventListener("mousedown", be),
    ...
    e.addEventListener("touchstart", Vt, oe ? { passive: !0 } : !1);
}
function mt(e) {
  e.removeEventListener("mousedown", be),
    e.removeEventListener("click", be),
    e.removeEventListener("touchstart", Vt),
    e.removeEventListener("touchend", Wt),
...
function Vt(e) {
  if (e.changedTouches.length === 1) {
    ...
    (t.$_vclosepopover_touchPoint = o),
      t.addEventListener("touchend", Wt),
      t.addEventListener("touchcancel", jt);
  }
}
function Wt(e) {
  const t = e.currentTarget;
...
const ii = {
    beforeMount(e, { value: t, modifiers: o }) {
      (e.$_closePopoverModifiers = o), (typeof t > "u" || t) && ft(e);
    },
    updated(e, { value: t, oldValue: o, modifiers: i }) {
      (e.$_closePopoverModifiers = i), t !== o && (typeof t > "u" || t ? ft(e) : mt(e));
    },
    beforeUnmount(e) {
      mt(e);
    },
...
function ni(e, t = {}) {
  e.$_vTooltipInstalled ||
    ...
    e.directive("close-popper", ii),
    e.component("VTooltip", Bt),
    e.component("VDropdown", Go),
    e.component("VMenu", Et));
}
const si = { version: "5.2.2", install: ni, options: H },
  Me =
    typeof navigator < "u" &&
  ...
  di = {
    install: (e, t = {}) => {
      ...
      if (
        typeof window < "u" &&
        (window.addEventListener("vitepress:codeGroupTabActivate", De, { passive: !0 }),
        window.addEventListener(
          "click",
          (s) => {
            s.composedPath().some((a) => {
              let l, d, p, c;
              return (
                ((d = (l = a == null ? void 0 : a.classList) == null ? void 0 : l.contains) == null
                  ? void 0
                  : d.call(l, "vp-code-group")) ||
                ((c = (p = a == null ? void 0 : a.classList) == null ? void 0 : p.contains) == null
                  ? void 0
                  : c.call(p, "tabs"))
              );
            }) && De();
        ...
        e.component = function (...a) {
          ...
          if (a.length >= 2 && a[0] === "VMenu")
            try {
              const p = a[1].components.Popper.extends,
                c = p.methods.show;
              p.methods.show = function (...h) {
                if (!s) return c.apply(this, h);
              };
              const u = p.methods.hide;
              p.methods.hide = function (...h) {
                if (!s) return u.apply(this, h);
              };
            } catch (d) {
              console.error("Failed to patch FloatingVue", d);
            }
          return l;
        };
      }
      e.use(si, {
        ...
        themes: {
          ...
          twoslash: {
            $extend: "dropdown",
            triggers: Me ? ["touch"] : ["hover", "touch"],
            popperTriggers: Me ? ["touch"] : ["hover", "touch"],
            ...
            ...(((o = t.themes) == null ? void 0 : o.twoslash) ?? {}),
          },
          "twoslash-query": {
            $extend: "twoslash",
            triggers: ["click"],
            ...
            autoHide: !1,
            noAutoFocus: !0,
            ...(((i = t.themes) == null ? void 0 : i["twoslash-query"]) ?? {}),
          },
          "twoslash-completion": {
            ...
            distance: 0,
            arrowOverflow: !0,
            ...(((n = t.themes) == null ? void 0 : n["twoslash-completion"]) ?? {}),
          },
          ...t.theme,
        },
      });
...
export { ai as L, di as T, li as V, De as t };
