...
| ask-routing-deferral                | `<state dir>/projects/<key>/ask-routing-deferral-calibration.jsonl`                                                                     | `.minsky/hooks/ask-routing-deferral-detector.ts`                                                                                | `matches: {class, phrase, context, sentence}[]`, plus `captureSchema` / `judged_text_hash` (mt#3866 — stamped together by `captureFields`, so the marker can no longer be present without an identity) and `turn_key` on the dispatcher path only (mt#3866 SC1 — `ctx.recordedAnchor.turnKey`; absent on the standalone path, which has no anchor)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | registered-explicit                                                                                                                                                     | ingest                                             |
