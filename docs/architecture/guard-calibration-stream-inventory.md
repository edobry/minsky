...
| policy-coverage (retired)         | `.minsky/policy-coverage-calibration.jsonl`                                                                          | RETIRED 2026-08-16 (mt#4197) — producer deleted; log retained as evidence                                                       | `{reason, outcome, evidence?}` (not matched-phrase; diversity over `reason`)                                                                                                                                | deregistered (mt#4197)                                                                                                                                          | ingest                                          |
