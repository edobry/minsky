...
| `--liveness-healthy/-idle/-stale/-orphaned` | (cockpit-local, no brand `success` token) | `0.580 0.140 145` / `0.720 0.175 70` / `0.560 0.215 27` / `0.470 0.020 240` | Cockpit-local liveness sub-tokens; brand palette intentionally has no `success` (per cockpit-design skill).                                                                                                                                                                        |
