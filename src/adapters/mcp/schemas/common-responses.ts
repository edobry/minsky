...
/**
 * Creates a file operation success response
 */
...
/**
 * Creates a file read success response
 */
...
/**
 * Creates a directory listing success response
 */
export function createDirectoryListResponse(
  context: { path: string; session: string; resolvedPath: string },
  listData: {
    files: string[];
    directories: string[];
