 ...
 */
export class TasksSimilarCommand extends DatabaseCommand {
  ...
  private async createTaskSimilarityService(provider: any): Promise<TaskSimilarityService> {
    ...
    // TaskSimilarityService is ready to use after construction - no initialize() needed
 ...
 * NEW PATTERN: Extends DatabaseCommand, receives provider via context injection
 */
export class TasksSearchCommand extends DatabaseCommand {
