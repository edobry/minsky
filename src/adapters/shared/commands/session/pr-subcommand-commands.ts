...
// Using existing session parameter definitions for type safety

/**
 * Session PR Create Command
 */
export class SessionPrCreateCommand extends DatabaseSessionCommand<any, any> {
 ...
 */
export class SessionPrEditCommand extends DatabaseSessionCommand<any, any> {
 ...
 */
export class SessionPrListCommand extends DatabaseSessionCommand<any, any> {
 ...
 */
export class SessionPrGetCommand extends DatabaseSessionCommand<any, any> {
 ...
 */
export class SessionPrOpenCommand extends DatabaseSessionCommand<any, any> {
