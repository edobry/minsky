...
export function createRoutingCommand(): Command {
  ...
  availableCmd.option("--limit <number>", "Maximum number of tasks to show", (v) => parseInt(v), 20);
  ...
  availableCmd.option("--min-readiness <number>", "Minimum readiness score (0.0-1.0)", (v) => parseFloat(v), 0.5);
  ...
  routeCmd.option("--strategy <strategy>", "Routing strategy: ready-first, shortest-path, value-first", "ready-first");
