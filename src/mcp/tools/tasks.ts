  ...
  commandMapper.addTaskCommand(
    ...
    async (args: z.infer<z.ZodObject<{taskId: z.ZodString}>>) => {
      try {
        ...
        throw new Error(`Failed to get task ${args.taskId}: ${error instanceof Error ? error.message : String(error)}`);
      }
    }
  );
  ...
  commandMapper.addTaskCommand(
    ...
    async (args: z.infer<z.ZodObject<{taskId: z.ZodString}>>) => {
      try {
        ...
        throw new Error(`Failed to get task status for ${args.taskId}: ${error instanceof Error ? error.message : String(error)}`);
      }
    }
  );
  ...
  commandMapper.addTaskCommand(
    ...
    async (args: z.infer<z.ZodObject<{
      ...
      try {
        ...
        throw new Error(`Failed to set task status for ${args.taskId}: ${error instanceof Error ? error.message : String(error)}`);
      }
    }
  );
