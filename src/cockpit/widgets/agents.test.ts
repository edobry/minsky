...
describe("createAgentsWidget — task title enrichment", () => {
  ...
  test("batch-fetches titles for all unique taskIds in one pass", async () => {
    ...
    const sessions = [
      makeActiveSession({ sessionId: "s1-0000-0000-0000-000000000001", taskId: "mt#100" }),
      makeActiveSession({ sessionId: "s2-0000-0000-0000-000000000002", taskId: "mt#200" }),
      // Third session re-uses mt#100 — should NOT trigger a second getTask call
      makeActiveSession({ sessionId: "s3-0000-0000-0000-000000000003", taskId: "mt#100" }),
    ];
    ...
    const s1 = agents.find((a) => a.sessionId === "s1-0000-0000-0000-000000000001");
    const s2 = agents.find((a) => a.sessionId === "s2-0000-0000-0000-000000000002");
    const s3 = agents.find((a) => a.sessionId === "s3-0000-0000-0000-000000000003");
