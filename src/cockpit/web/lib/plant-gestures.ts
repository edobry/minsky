 ...
 * `subagent.completed`) are mapped so their gestures activate the moment
 * mt#2481 wires the emit sites — mapping an unemitted type costs nothing
 * and is not fake motion (no rows → no gestures).
 */
