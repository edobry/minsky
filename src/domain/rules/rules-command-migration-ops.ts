/**
 * Rules Command Migration & Search Operations
 *
 * Operations for migrating rules between directories, indexing embeddings,
 * and performing enhanced similarity searches.
 */
