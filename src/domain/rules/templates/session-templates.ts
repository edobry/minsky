 ...
 *
 * Contains MINSKY_SESSION_MANAGEMENT_TEMPLATE.
 */
 ...
 */
export const MINSKY_SESSION_MANAGEMENT_TEMPLATE: RuleTemplate = {
...
export const SESSION_TEMPLATES: RuleTemplate[] = [MINSKY_SESSION_MANAGEMENT_TEMPLATE];
