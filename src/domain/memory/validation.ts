 ...
 *
 * Lives in the domain layer so both the command-layer validator (child 2)
 * and the importer script (child 3) share the same logic without duplication.
 *
 * @see mt#960 Memory quality rubric
 * @see mt#1007 MCP + CLI command surface (consumer)
 * @see mt#1008 One-shot importer (consumer)
 */
