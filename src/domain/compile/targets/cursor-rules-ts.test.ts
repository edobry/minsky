...
describe("buildRuleMdc", () => {
  ...
  describe("generated-file banner", () => {
    ...
    it("banner matches the hook's `# Generated by` regex (regression guard)", () => {
      ...
      // multiline). If either side drifts, this test fails.
      const mdc = buildRuleMdc(sampleRule);
    ...
    it("banner present even when only the name field is set", () => {
      ...
      expect(mdc.split("\n")[1]).toBe("# Generated by minsky rules compile. Do not edit directly.");
    });
  });
});
