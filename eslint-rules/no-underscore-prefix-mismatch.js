...
export default {
  meta: {
    ...
    docs: {
      description:
        "Disallow underscore prefix variables being declared but used without underscores",
    ...
    schema: [],
    messages: {
      underscorePrefixMismatch:
        "Variable '{{name}}' is declared with underscore prefix but used without underscore. Either remove underscore from declaration or use '{{prefixedName}}' consistently.",
      declarationShouldNotHaveUnderscore:
        "Variable '{{name}}' is used without underscore but declared with underscore prefix. Remove underscore from declaration: '{{unprefixedName}}'.",
    },
  },
