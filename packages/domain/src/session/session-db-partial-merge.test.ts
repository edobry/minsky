 ...
 *
 * Exercised through `FakeSessionProvider` (the call-site pattern via the
 * provider interface). The former Section B, which tested the retired
 * `updateSessionFn` pure function directly, was removed in mt#2329.
 */
