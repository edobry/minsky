...
import { createTaskTestDeps } from "../../../src/utils/test-utils/dependencies";
import type { TaskDependencies } from "../../../src/utils/test-utils/dependencies";
  ...
  beforeEach(async () => {
    ...
    taskDeps = createTaskTestDeps({
      taskService: {
        ...
        setTaskStatus: () => Promise.resolve({ recordsAffected: 1 }),
