/**
 * Decision tests for the GitHub MCP PR-write denial.
 *
 * Moved here from `.minsky/hooks/block-github-mcp-pr-writes.test.ts` by mt#4374
 * (SC4). They exercise the decision directly — no hook payload is constructed
 * anywhere in this file, which is mt#4374 AT2.
 */
import { describe, expect, it } from "bun:test";
import { checkToolDenial, toolDenials } from "./github-mcp-pr-write-denial";
