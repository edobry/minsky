...
export const HOOK_ONLY_ENV_VARS: ReadonlySet<string> = new Set([
  ...
  "MINSKY_DAEMON_TRACKER_HOME", // .claude/hooks/mcp-daemon-staleness-detector.ts (mt#3004) — test-only tracker-home override for the guard-canary suite
  "MINSKY_MEMORY_SEARCH_CANARY_STUB", // .claude/hooks/memory-search.ts (mt#3004) — test-only fixture-file stub replacing the CLI subprocess in the guard-canary suite
