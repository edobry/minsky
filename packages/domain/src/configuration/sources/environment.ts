...
export const HOOK_ONLY_ENV_VARS: ReadonlySet<string> = new Set([
  ...
  "MINSKY_ACK_REVIEW_REQUEST_CHANGES", // .claude/hooks/require-review-before-merge.ts (mt#2989) — audited override for a verified-false-positive REQUEST_CHANGES review
