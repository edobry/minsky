...
export const HOOK_ONLY_ENV_VARS: ReadonlySet<string> = new Set([
  ...
  "MINSKY_SKIP_NEW_SURFACE_DESIGN_PASS", // .claude/hooks/new-surface-design-pass.ts (mt#4124) — skip the log-only scan for a branch that ADDS a render-path surface with no design skill invoked
  ...
  "MINSKY_SKIP_SPEC_CRITERION_CLAIM", // .claude/hooks/spec-criterion-claim-detector.ts (mt#4153) — override for the spec-criterion unverified-assertion / invented-precondition detector
