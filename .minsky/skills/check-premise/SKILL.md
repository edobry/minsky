...
name: check-premise
description: >-
  Before asserting a causal or mechanism claim about tool/system behavior,
  list the factual premises the claim rests on, identify the cheapest
  falsifier first, and check it (read the installed source / query the
  system's own record / grep) before asserting. Use when about to explain
  WHY something happened or WHAT a tool will do based on an assumed mechanism.
user-invocable: true
---
