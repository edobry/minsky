...
export default defineSkill({
  name: "review-pr",
  description:
    "Review a pull request with codebase-verified findings and spec verification, posted as an actual GitHub PR review. Use when asked to review a PR, or when a PR is ready for review after subagent work.",
  userInvocable: true,
  content: `
# PR Review Skill
