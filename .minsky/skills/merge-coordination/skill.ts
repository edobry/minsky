...
export default defineSkill({
  ...
  description:
    "Main-agent skill for coordinating the merge of a PR after the canonical `minsky-reviewer[bot]` review. Covers: gathering bot review status, running the local smoke test, diagnosing reviewer-bot silence, and bypass-merging bot-authored PRs.",
  userInvocable: true,
  content: `
