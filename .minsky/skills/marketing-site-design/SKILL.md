...
description: >-
  ...
  launch pages, position-paper landing pages. Layers marketing patterns on `minsky-brand`
  and consumes `analyze-adjacent-product`'s output. Use when designing or auditing a
  Minsky marketing surface.
user-invocable: true
---
