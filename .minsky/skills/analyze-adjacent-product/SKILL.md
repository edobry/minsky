...
description: >-
  Semiotic analysis of an adjacent product's marketing surface or brand positioning, via
  the Peirce triad, Barthes' orders of signification, and Oswald's cultural codes. Use when
  reading a competitor site or reference brand structurally — for positioning, RFC support,
  build-vs-buy, or feeding a marketing-site-design workshop.
user-invocable: true
---
