...
description: >-
  Package a principal-facing escalation so it can be decided from the message alone —
  content and form checklists. Use before an ask, an AskUserQuestion, or any turn-ending
  question handing the principal a decision.
user-invocable: true
---
