 ...
 *     ...
 *     + N more
 *   Run /restart to load fresh content, or proceed with awareness that
 *   previously-invoked skills may use cached old logic.
 */
export function buildWarning(stale: StaleEntry[]): string {
  ...
  lines.push(
    "Run /restart to load fresh content, or proceed with awareness that previously-invoked skills may use cached old logic."
  );
