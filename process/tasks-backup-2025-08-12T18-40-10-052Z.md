...
- [+] Add --draft mode to session pr create [#1](process/tasks/md#1-add-draft-mode-to-session-pr-create.md)

- [ ] Add --draft mode to session pr create [#1](process/tasks/md#1-add-draft-mode-to-session-pr-create.md)

- [ ] Add a --draft mode to session pr create which only works with the github repo backend and DOES NOT do a session update [#1](process/tasks/md#1-add-a-draft-mode-to-session-pr-create-which-only-works-with-the-github-repo-backend-and-does-not-do-a-session-update.md)

- [ ] Implement GitHub backend merge to use PR title/body for merge commit message and update guardrails spec to include repo default merge commit message settings (merge_commit_title=PR_TITLE, merge_commit_message=PR_BODY). [#1](process/tasks/md#1-implement-github-backend-merge-to-use-pr-title-body-for-merge-commit-message-and-update-guardrails-spec-to-include-repo-default-merge-commit-message-settings-merge-commit-title-pr-title-merge-commit-message-pr-body-.md)
...
- [ ] Implement GitHub backend merge to use PR title/body as merge commit title/body; update guardrails spec to include repo default merge commit message settings (merge_commit_title=PR_TITLE, merge_commit_message=PR_BODY). [#1](process/tasks/md#1-implement-github-backend-merge-to-use-pr-title-body-as-merge-commit-title-body-update-guardrails-spec-to-include-repo-default-merge-commit-message-settings-merge-commit-title-pr-title-merge-commit-message-pr-body-.md)

- [ ] Implement GitHub backend merge to use PR title/body for merge commit message; update guardrails spec to include repo default merge commit message settings (merge_commit_title=PR_TITLE, merge_commit_message=PR_BODY). [#1](process/tasks/md#1-implement-github-backend-merge-to-use-pr-title-body-for-merge-commit-message-update-guardrails-spec-to-include-repo-default-merge-commit-message-settings-merge-commit-title-pr-title-merge-commit-message-pr-body-.md)

- [ ] Add session repair command and --draft mode to session pr create [md#1](process/tasks/md#1-add-session-repair-command-and-draft-mode-to-session-pr-create.md)