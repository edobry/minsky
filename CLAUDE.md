...
rebuild + reinstall acknowledgment is hard-blocked. Override: `MINSKY_SKIP_USABILITY_CLAIM_CHECK=1`
(independent of `MINSKY_SKIP_DEPLOY_VERIFY`); shares the `[no-deploy-impact]` title escape.
