...
1. **Main agent** orchestrates via MCP tools: create tasks, start sessions, manage status, create PRs.
2. **Subagents** do implementation work in session directories. Never edit session files from the main agent.
3. All file operations in sessions MUST use absolute paths.
