...
description: >-
  ...
  (triage/decide/steer/verify), not dashboard convention. Use when designing,
  auditing, or critiquing a surface, comparing one against another tool or
  surface, or deciding what it should adopt. Above /cockpit-design and
  /minsky-brand.
user-invocable: true
---
