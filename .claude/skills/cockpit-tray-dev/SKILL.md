...
description: >-
  ...
  (cockpit-tray/**). Covers the two-layer model (web changes auto-rebuild; the
  Rust binary does not), the dev loop, and the release-install path. Use when
  working in cockpit-tray/**, or asking why a merged change is not in the menu
  bar.
user-invocable: true
---
