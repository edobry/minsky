...
description: >-
  ...
  papers, blog posts, architecture memos, argumentative RFCs. Structural
  patterns, heading heuristics, revision workflow. Not for task specs, rule
  files, or short internal docs.
user-invocable: true
---
