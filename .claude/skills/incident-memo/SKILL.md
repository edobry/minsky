...
description: >-
  ...
  when the session has produced 2 or more retrospectives, merged 3 or more PRs,
  or the user explicitly asks for an incident memo / day synthesis /
  meta-retrospective. Distinct from the retrospective skill (per-incident); this
  skill operates at the cross-incident layer and produces a Notion page +
