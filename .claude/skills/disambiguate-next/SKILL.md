...
description: >-
  Before chain-walking on a brief affirmative at a task-graph junction, check
  whether multiple unblocked sibling/child tasks exist; if so surface the choice
  instead of walking to a self-derived default. Use when a task reaches DONE and
  ≥2 siblings become walkable.
user-invocable: true
---
