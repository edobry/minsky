...
description: >-
  Deep research pass with the Fable-bookended fan-out pattern: plan (decompose
  into independent workstreams), fan out (fresh subagents research in parallel),
  synthesize. Use for research, prior-art, or landscape surveys — or an explicit
  "plan, fan out, synthesize". NOT for a single-fact lookup; sandwiching a
  one-liner is waste.
user-invocable: true
---
