...
description: >-
  ...
  lookup-answerable, covered by a standing default, genuinely principal-owned,
  or recommending-instead-of-acting — and act on the classification instead. Use
  when about to end a turn with a question, write deferral-shaped prose, or fill
  a checklist slot asking you to state a strategy.
user-invocable: true
---
