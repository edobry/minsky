...
name: postmortem
description: >-
  Blameless postmortem for a RESOLVED production incident — outage, degradation,
  data loss, or near-miss affecting shared/prod state or customers. Produces
  docs/incidents/<date>-<topic>.md. Distinct from /retrospective (agent process
  failures) and /incident-memo (cross-incident synthesis).
user-invocable: true
---
