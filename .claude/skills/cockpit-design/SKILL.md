...
name: cockpit-design
description: >-
  Minsky-domain patterns for Cockpit UI work: the entity model and its
  conventions, mission-control density, command-palette UX, drill-down
  navigation, attention-debt visualization. Use when designing or rebuilding
  Cockpit widgets (src/cockpit/web/**), implementing entity displays, or
