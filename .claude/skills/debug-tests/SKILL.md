...
description: >-
  ...
  Use when tests are failing, debugging test issues, or encountering bun:test
  problems. Covers infinite loop detection, mock issues, variable naming traps,
  and category-by-category fixing.
user-invocable: true
---
