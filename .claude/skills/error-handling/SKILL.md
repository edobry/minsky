...
description: >-
  ...
  degradation, context preservation, resource cleanup, timeouts, and
  user-friendly error messages. Use when handling errors, designing error
  strategies, or implementing error recovery.
user-invocable: true
---
