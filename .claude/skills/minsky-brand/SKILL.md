...
description: >-
  ...
  position paper (Notion) is the *strategic* tier, `docs/brand-system.md` is the
  *operational* tier, this skill is the *agent-consumable* tier. Composes with
  `pz-voice` (signal — what is claimed); this skill is the channel (how it feels
  to the audience). Invoke as the strategic anchor for any Minsky-surface design
  work (`marketing-site-design`, `cockpit-design`) or any artifact that needs to
