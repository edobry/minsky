...
description: >-
  Apply the core Designing Data-Intensive Applications decision frames at
  data-design time, as a checklist. Use when designing a schema, a persistence
  path, a cache/index/materialized view, a sync mechanism, an event/queue, or a
  migration — it asks the system-of-record, dual-writes, rebuildability, and
  idempotency questions first.
user-invocable: true
---
