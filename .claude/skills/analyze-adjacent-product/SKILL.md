...
- [`.claude/skills/name-product/SKILL.md`](../name-product/SKILL.md) — _synthesis dual_ of this skill. This skill reads an existing name/brand semiotically (analysis); `name-product` generates one using the Lexicon framework (synthesis). Use it when an adjacent-product naming read should feed a naming decision of our own.
