...
Ask: "I've rated this plan {N}/10 on design completeness. The biggest gaps are {X, Y, Z}. I'll review all 7 dimensions. Want me to focus on specific areas instead of all 7?"
...
**STOP.** Ask once per issue. Do NOT batch. Recommend + WHY. If no issues, say so and move on.
