...
description: >-
  ...
  format with sequential numbering in docs/architecture/adr-NNN-<slug>.md.
  Use when committing to one architectural choice among alternatives where
  future readers will ask "why this and not that?" — single decisions, not
