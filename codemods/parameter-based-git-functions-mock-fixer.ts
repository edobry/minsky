            ...
            ts.factory.createBlock([
              ...
              ts.factory.createReturnStatement(
                ts.factory.createObjectLiteralExpression([
                  ...
                  ts.factory.createPropertyAssignment("workdir", ts.factory.createStringLiteral("/mock/workdir"))
                ])
              )
            ], true)
          );
...
try {
  ...
  console.error("❌ Error applying Parameter-Based Git Functions Mock Infrastructure fixes:", error);
  process.exit(1);
} 
