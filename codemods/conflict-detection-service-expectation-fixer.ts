...
export function fixConflictDetectionExpectations(
  sourceFile: SourceFile
): ConflictDetectionFixResult {
  ...
  if (fixed) {
    return {
      ...
      changed: true,
      reason:
        "Updated ConflictDetectionService test expectations to match correct implementation behavior",
    };
  }
