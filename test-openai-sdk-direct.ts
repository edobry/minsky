  ...
  try {
    ...
    try {
      ...
      try {
        ...
        console.log("❌ Test 2 also failed:", error2 instanceof Error ? error2.message : String(error2));
        ...
        try {
          ...
          console.log("❌ Test 3 also failed:", error3 instanceof Error ? error3.message : String(error3));
